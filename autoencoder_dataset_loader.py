...
class CustomDataset(Dataset):
    ...
    def __init__(self, x_, y_, numbers_, transform=None, padding_size=(0, 0)):
        self.x = x_
        self.y = y_
    ...
    def __getitem__(self, index):
        ...
        return self.normalize(x_image), self.normalize(y_image), self.numbers[index]
...
if __name__ == "__main__":
    ...
    for path in glob.glob("/home/vodohleb/PycharmProjects/tensor_flow/SOCOFing/Real" + "/*"):
